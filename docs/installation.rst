...
``tendril-interests`` can be installed normally from the Python Package Index.
...
`github releases <https://github.com/tendril-framework/tendril-interests/releases>`_.
...
``tendril-interests``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-interests.git
    $ cd tendril-interests
    $ pip install -e .
